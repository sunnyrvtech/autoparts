...
class SubCategoryController extends Controller {
    ...
    public function getProductByCategoryVehicleModelSlug(Request $request, $vehicle, $model, $cat) {
        ...
        $vehicle_company = VehicleCompany::where('slug', 'like', $vehicle . '%')->first(array('id', 'name', 'slug'));
        $data['products'] = Product::with(['product_details', 'get_brands', 'get_vehicle_company', 'get_vehicle_model'])->where([['vehicle_make_id', '=', $vehicle_company->id], ['vehicle_model_id', '=', $vehicle_model->id], ['sub_category_id', '=', $sub_categories->id],['quantity', '>', 0], ['status', '=', 1]])->paginate(20);
