...
<div class="container-fluid">
    ...
    <!-- /.row -->
    <div class="row">
        <?php echo e(Form::open(array('route' => ['subsubcategories.update',$subsub_categories->id],'method'=>'PUT', 'class' => 'form-horizontal','enctype'=>'multipart/form-data'))); ?>
            ...
            <div class="col-lg-6">
                <div class="form-group <?php echo e($errors->has('sub_category_id') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-sm-9 col-md-9">  
                        <?php echo e(Form::select('sub_category_id', $sub_categories,$subsub_categories->sub_category_id,['class' => 'form-control'])); ?>
                ...
                <div class="form-group <?php echo e($errors->has('vehicle_company_id') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-sm-9 col-md-9">  
                        <?php echo e(Form::select('vehicle_company_id', $vehicle_companies,$subsub_categories->vehicle_company_id,['class' => 'form-control'])); ?>
