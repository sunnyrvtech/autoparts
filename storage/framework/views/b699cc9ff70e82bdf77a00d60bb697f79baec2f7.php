                                                                        ...
                                                                        <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td align="center" valign="top" class="textContent">
                                                                                    <?php if($transaction_details['store_email']): ?>
                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            <td valign="top" class="textContent">
                                                                                                <h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:center;">Your Order #<?php echo e($transaction_details['transaction_id']); ?></h3>
                                                                                                <div mc:edit="body" style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Placed on <?php echo e($transaction_details['order_time']); ?></div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    <!-- // CONTENT TABLE -->
                                        ...
                                        <tr>
                                            <td align="center" valign="top">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 10px;">
                                                    ...
                                                    <?php $total_price = ''; ?>
                                                    <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                    <?php $total_price += $value->total_price; ?>
                                                    <tr style="border-bottom: 1px solid #C8C8C8;">
                                                        <td align="left" width="80%" style="padding: 15px;"><span style="font-weight: bold;"><?php echo e($value->get_products->product_name); ?></span><br><span>SKU: <?php echo e($value->get_products->part_number); ?></span></td>
                                                        <td width="20%" style="padding: 15px;"><?php echo e($value->quantity); ?></td>
                                                        <td width="20%" style="padding: 15px;">$<?php echo e($value->total_price); ?></td>
                                                    </tr>
                                                                                ...
                                                                                <td align="center" valign="top">
                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:right;">$<?php echo e(number_format($total_price,2)); ?></h3>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                            ...
                                                                                            <td>
                                                                                                <h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:right;">$<?php echo e($transaction_details['shipping_price']); ?></h3>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                            ...
                                                                                            <td>
                                                                                                <h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:right;">$<?php echo e(number_format($total_price+$transaction_details['shipping_price'],2)); ?></h3>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    <!-- // CONTENT TABLE -->
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" class="textContent">
                                                                                                ...
                                                                                                <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;line-height:135%;">
                                                                                                    <span><?php echo e(Auth::user()->first_name.' '.Auth::user()->last_name); ?></span><br/>
                                                                                                    <span><?php echo e($billing_address->address1); ?></span><br/>
                                                                                                    <span><?php echo e($billing_address->address2); ?></span><br/>
                                                                                                    <span><?php echo e($billing_address->city.','.$billing_address->get_state->name.','.$billing_address->zip.' '.$billing_address->get_country->name); ?></span>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    ...
                                                                                    <table class="flexibleContainerBoxNext" border="0" cellpadding="30" cellspacing="0" width="100%" style="max-width:100%;">
                                                                                        <tr>
                                                                                            <td align="left" class="textContent">
                                                                                                ...
                                                                                                <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;line-height:135%;">
                                                                                                    <span><?php echo e(Auth::user()->first_name.' '.Auth::user()->last_name); ?></span><br/>
                                                                                                    <span><?php echo e($shipping_address->address1); ?></span><br/>
                                                                                                    <span><?php echo e($shipping_address->address2); ?></span><br/>
                                                                                                    <span><?php echo e($shipping_address->city.','.$shipping_address->get_state->name.','.$shipping_address->zip.' '.$shipping_address->get_country->name); ?></span>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top" bgcolor="#E1E1E1">
                                                                                    ...
                                                                                    <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                        <div>Copyright &#169; <?php echo e(date('Y')); ?>. All&nbsp;rights&nbsp;reserved.</div>
                                                                                    </div>
