            ...
            <nav class="navbar navbar-default navbar-static-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="mini-cart pull-right hidden-md hidden-lg" id="mobile-mini-cart" href="<?php echo e(URL('/cart')); ?>">
                            <span class="fab-cirle am-bg-dark-blue">
                                <span aria-hidden="true" class="glyphicon glyphicon-shopping-cart"></span>
                            </span>
                            <span class="mini-cart-count" ng-bind="cart_count" ng-init="cart_count='<?php echo e($cart_count); ?>'"></span>
                            <span class="hidden-xxs"> items in cart:</span>
<!--                            <span class="visible-xxs-inline"> / </span>
                            <span class="mini-cart-total">$0.00</span>-->
                        </a>

                        <a class="navbar-brand" title="Auto-LightHouse" href="<?php echo e(url('/')); ?>"></a>
                    </div>
                    <div class="navbar-collapse collapse" id="navbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                            <?php if(Auth::check()): ?>
                                <a href="<?php echo e(URL('/my-account/order')); ?>" title="Track your order">Order Tracking</a>
                            <?php else: ?>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="active mini-cart dropdown" id="desktop-mini-cart">
                                <a href="<?php echo e(URL('/cart')); ?>">
                                    ...
                                    <span class="mini-cart-count" ng-bind="cart_count" ng-init="cart_count='<?php echo e($cart_count); ?>'"></span>  items in cart:
                                    <!--<span class="mini-cart-total">$0.00</span>-->
                                </a>
                            </li>
                            <?php if(Auth::guest()): ?>
                ...
                <div class="row">
                     <div class="col-lg-4 col-md-4 col-sm-4">
                        ...
                        <ul>
                            ...
                            <li>
                            <?php if(Auth::check()): ?>
                                <a href="<?php echo e(URL('/my-account/order')); ?>" title="Track your order">Track Your Order</a>
                            <?php else: ?>
