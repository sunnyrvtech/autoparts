...
<div class="container-fluid">
    ...
    <!-- /.row -->
    <div class="row">
        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ route('zones.update',$product_zones->id)}}">
                ...
                <div class="col-lg-6">
                    <div class="form-group {{ $errors->has('zone_name') ? ' has-error' : ''}}">
                        ...
                        <div class="col-sm-9 col-md-9">
                            <input type="text" required="" name="zone_name" value="{{ $product_zones->zone_name }}" class="form-control" placeholder="Zone Name">
                    ...
                    <div class="form-group {{ $errors->has('states') ? ' has-error' : ''}}">
                        ...
                        <div class="col-sm-9 col-md-9">
                            <select required="" name="states[]" class="form-control" id="states" multiple="multiple">
                                ...
                                <?php 
                                    $state_array = json_decode($product_zones->state_id);
