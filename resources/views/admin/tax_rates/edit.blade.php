...
<div class="container-fluid">
    ...
    <!-- /.row -->
    <div class="row">
        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ route('tax_rates.update',$tax_rates->id)}}">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group {{ $errors->has('country_id') ? ' has-error' : ''}}">
                        ...
                        <div class="col-sm-9 col-md-9">
                            <select required="" name="country_id" id="country_id" class="form-control">
                                ...
                                <option @if($tax_rates->country_id == $value->id) selected @endif value="{{ $value->id }}">{{ $value->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group {{ $errors->has('states') ? ' has-error' : ''}}">
                        ...
                        <div class="col-sm-9 col-md-9">
                            <select required="" name="states[]" class="form-control" id="states" multiple="multiple">
                                ...
                                <?php
                                $state_array = json_decode($tax_rates->state_id);
                                if (in_array($value->id, $state_array)) {
                                    $selected = 'selected';
                                } else {
                                    $selected = '';
                                }
                    ...
                    <div class="form-group {{ $errors->has('price') ? ' has-error' : ''}}">
                        ...
                        <div class="col-sm-9 col-md-9">
                            <input type="text" required="" name="price" value="{{ $tax_rates->price }}" class="form-control" placeholder="Price">
                            @if ($errors->has('price'))
                            <span class="help-block">
