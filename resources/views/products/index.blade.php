                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p class="group inner grid-group-item-text">
                            {{ str_limit("Product description... Lorem ipsum dolor sit amet, consectetuer adipiscing elit,sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.", $limit = 50, $end = '...') }}
                        </p>
                        <p class="group inner list-group-item-text">
                            {{ str_limit("Product description... Lorem ipsum dolor sit amet, consectetuer adipiscing elit,sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.", $limit = 200, $end = '...') }}
                        </p>
                        <div class="row">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#products-content-area .item").hover(function () {
